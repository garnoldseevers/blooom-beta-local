...
function bloom_calculator_render($atts, $content = "") {
	...
	wp_enqueue_style( 'bc-style-google-fonts', 'https://fonts.googleapis.com/css?family=Raleway:400,200,300,700,600,500' );
	wp_enqueue_style( 'bc-style-bootstrap', plugins_url( '/css/bootstrap.min.css',__FILE__) );
	wp_enqueue_style( 'bc-style-calculator', plugins_url( '/style-calculator.css',__FILE__) );
	
	wp_enqueue_script( 'bc-js-ui-custom', plugins_url( '/js/jquery-ui.min.js',__FILE__), array('jquery') );
	wp_enqueue_script( 'bc-js-plugins', plugins_url( '/js/plugins.js',__FILE__), array('jquery') );
	wp_enqueue_script( 'bc-js-main', plugins_url( '/js/main.js',__FILE__), array('jquery') );
	...
	$o .= '<div class="page-wrapper calculator-shortcode-wrapper">
							<div class="calc-hero row">
								<div class="col-md-8 col-sm-10 col-md-offset-2 col-sm-offset-1 text-center">
									...
									If you are looking for 401k help, you are the right place. At blooom we keep things simple. <br>
									And if you think this calculator is easy to use, you should see just <br>
									how easy it is to have us <strong>manage you 401k for you!</strong> </div>
							</div>
									...
									<form id="calculator" class="form-holder">
										...
										<div class="current-balance fieldset-container">
											...
											<div class="field">
												...
												<input type="text" class="calculate-input input-money" id="current-balance" name="current" autocomplete="off" placeholder="TYPE HERE.."/>
											</div>
										</div>
										<div class="yearly-savings fieldset-container">
											...
											<div class="field">
												<div class="prepend">$</div>
												<input type="text" class="calculate-input input-money" id="yearly-saving" name="saving" autocomplete="off" placeholder="TYPE HERE.."/>
											</div>
										</div>
										...
										<div class="result-amount">
											...
											<div class="bloom-result-container the-results"> <span class="bullet-top"></span> <span class="line-top"></span>
												...
												<div class="bloom-title">
													<div class="inner-title">Your 401k with<br/>
