...
!function(t){"use strict";var a=AwesomeUtil.detect_os();"MacOS"==a&&t("html").addClass("mac"),t(function(){var a,e=new AwesomeAjax("ats"),n=new ATS_Ajax;t('[data-action="add-model"]').on("keypress",function(t){return 13!=t.keyCode}),t('input[data-action="add-model"]').on("keyup",function(a){var n=t(this),o=t(this).parents(".panel-footer").find(".a-spinner"),i=t(this).parent("form"),s=t(this).attr("data-model");13==a.keyCode&&(o.show(),e.ajax({action:"ats_update_or_new_"+s,data:{data:{name:i.find("input").val()},model:s},success_handler:function(t){n.val(""),setTimeout(function(){window.location.reload()},500)}}))}),t("#action-settings").on("click",function(){var t={html:"#settings-wrap",width:"100%"};a=new AwesomePanel(t),a.init()}),t('[data-action="modal"]').lightbox({minWidth:50,minHeight:100,labels:{close:'<svg viewBox="0 0 56 56"><use xlink:href="#icon-delete"></use></svg>'}});var o={id:"ats",container:"#action-add-buttons",content:"#action-add-buttons-tooltip",width:180,data:{}},i=new AwesomeTooltip(o);i.init(),n.get_templates()})}(jQuery);
...
var AwesomeDrag=function(){"use strict";var e=jQuery,t=this;t.sortableEl=".connected-sortable",t.employers_panel="#panel-employers",t.cloneEmployers=function(){var l=e(t.employers_panel).clone().removeAttr("id").attr("panel","employers-clone").addClass("at-transition");window.ats_employers_clone=ats_employers.clone(),setTimeout(function(){e(t.employers_panel).fadeOut()},100);var a=l.find("li"),o=model.get("employers")||[];e.each(a,function(){var t=parseInt(e(this).attr("employer-id"));if(AwesomeUtil.find_in_array_of_objects(o,"ID",t)){var a=ats_employers_clone.findWhere({id:t});e(this,l).remove(),ats_employers_clone.remove(a)}});var s=e('<li><button data-action="push-all-employers"><span title="Push all">Push all</span></button></li>');l.find(".panel-heading .panel-actions").prepend(s),e(".employers-list",ats_panel).html(l),t.bind_clone(),e(document).on("click",'[data-action="remove-employer"]',function(){var l=e(this).parents("li[employer-id]"),a=+l.attr("employer-id"),o=ats_employers.findWhere({id:a});e("#employers-list",ats_panel).append(l),ats_employers_clone.add(o),t.updateElements()})},t.bind_clone=function(){e(document).on("mouseenter",".panel-pop-up #employers-list",function(){e("#team-sortable",ats_panel).addClass("pulsate")}),e(document).on("mouseleave",".panel-pop-up #employers-list",function(){e("#team-sortable",ats_panel).removeClass("pulsate")}),e(document).on("click",'[data-action="push-all-employers"]',function(){ats_employers_clone.reset();var t=e("ul.employers-list > li",ats_panel),l=_.clone(model.get("employers_ids"));e.each(t,function(t,a){e("#team-sortable",ats_panel).append(a);var o=parseInt(e(a).attr("employer-id"));l.push(o)}),model.set("employers_ids",l)}),e(document).on("click",'[data-action="remove-all-employers"]',function(){var t=e("#team-sortable > li",ats_panel);e.each(t,function(t,l){e("ul.employers-list",ats_panel).append(l);var a=parseInt(e(l).attr("employer-id")),o=ats_employers.findWhere({id:a});ats_employers_clone.add(o)}),model.set("employers_ids",[])})},t.initSortable=function(){e(t.sortableEl).addClass("sortable-placeholder"),e("#team-sortable, #employers-list").sortable({appendTo:"body",zIndex:99999,connectWith:t.sortableEl,forcePlaceholderSize:!0,placeholder:"sortable-placeholder-inner",cursor:"move",cursorAt:{top:25,left:25},helper:function(t,l){var a=e(l).find(".foto").clone(),o=e('<li class="item"></li>').append(a);return o},create:function(e,t){},start:function(t,l){e(l.helper).addClass("pop-up"),e(".a-slide-panel #team-sortable").addClass("drop-highlight")},stop:function(t,l){e(".a-slide-panel #team-sortable").removeClass("drop-highlight")},update:function(l,a){e(a.item).attr("style","");var o=e(a.item[0].parentElement).attr("id"),s=parseInt(e(a.item[0]).attr("employer-id")),n=ats_employers.findWhere({id:s});"team-sortable"==o?ats_employers_clone.remove(n):"employers-list"==o&&ats_employers_clone.add(n),t.updateElements()}})},t.updateElements=function(){var t=e("#team-employers",ats_panel);t.val("");var l=[],a=[];e("#team-sortable li",ats_panel).each(function(){var t=parseInt(e(this).attr("employer-id")),o=e(this).find("img").attr("src"),s=e(this).find(".name").html(),n=e(this).find(".position").html(),r=e(this).find(".teams_count").html();a.push(t),l.push({ID:t,foto:o,post_title:s,position:n,teams_count:r})});var o=JSON.stringify(a);t.val(o),model.set("employers_ids",a),model.set("employers",l)},t.destroy=function(){e(t.employers_panel).show(),e(".panel.panel-pop-up").remove(),e(".connected-sortable").removeClass("sortable-placeholder"),e("#employers-list").sortable({disabled:!0}),e(".employers-list",ats_panel).html(""),e(".panel-pop-up #employers-list").off()},t.init=function(){t.cloneEmployers(),t.updateElements(),t.initSortable()}};
var ATS_Ajax=function(){"use strict";var i=jQuery,l="ats",e=new AwesomeAjax(l),t=this;t.result={},t.load_model=function(t,_){if(i.isNumeric(t))return e.load_model(_,t,function(i){window.model=new AwesomeModel(i)});if("#"==t){if("team"==_)return e.ajax({action:l+"_get_team_defaults",success_handler:function(i){window.model=new AwesomeModel(i)}});if("employer"==_)return e.ajax({action:l+"_get_employer_defaults",success_handler:function(i){window.model=new AwesomeModel(i)}})}},t.fill_team_layout_html=function(i,l,e){},t.fill_blocks_order=function(i,l,e){var t=JSON.stringify(e);i.find('[name="team_'+l+'"]').val(t)},t.fill_team_grid_blocks_order=t.fill_blocks_order.bind(t),t.fill_team_table_blocks_order=t.fill_blocks_order.bind(t),t.fill_team_employers=function(e,t,o){var n="",a=[];i.each(o,function(i,e){a.push(e.ID);var t=e.foto?'<img width="40" height="40" src="'+e.foto+'">':'<img src="'+window[l+"_localize"].default_avatar+'" alt="" />',o='                <li data-action="edit-employer" class="clearfix" employer-id="{ID}" title="{name}">                    <div class="foto" data-wr_replaced="true">                        {foto}                    </div>                    <span class="name">{name}</span>                    <span class="position">{position}</span>                    <div class="teams"><span class="teams_count">{teams_count}</span> Teams</div>                    <button class="btn-action remove-employer at-transition at-transition-fast" title="Remove" data-action="remove-employer">                        <svg viewBox="0 0 20 20">                            <use xlink:href="#icon-delete"></use>                        </svg>                    </button>                </li>';n+=o.replace_all("{name}",_.escape(e.post_title)).replace_all("{foto}",t).replace_all("{ID}",e.ID).replace_all("{position}",_.escape(e.position)).replace_all("{teams_count}",e.teams_count)}),i(e).find("#team-employers").val(JSON.stringify(a)),i(e).find("#team-sortable").html("").append(n)},t.fill_color=function(l,e,t){e=e.replace_all("team_",""),i(l).find("."+e).find("input").val(t),i(l).find("."+e).find("span.color > i").css("background-color",t)},t.fill_team_button_color=t.fill_color.bind(t),t.fill_team_button_hover_color=t.fill_color.bind(t),t.fill_team_button_text_color=t.fill_color.bind(t),t.fill_team_button_text_hover_color=t.fill_color.bind(t),t.fill_team_base_color=t.fill_color.bind(t),t.fill_team_card_base_color=t.fill_color.bind(t),t.fill_team_card_border_color=t.fill_color.bind(t),t.fill_team_card_divider_color=t.fill_color.bind(t),t.fill_team_card_shadow_color=t.fill_color.bind(t),t.fill_team_card_even_row_color=t.fill_color.bind(t),t.fill_team_panel_color=t.fill_color.bind(t),t.fill_team_photo_shape=function(i,l,e){},t.fill_team_photo_size=function(i,l,e){},t.fill_visibility=function(l,e,t){i(l).find('[name="'+e+'"]').attr("data-checked",t).val(t)},t.fill_team_slider=t.fill_visibility.bind(t),t.fill_team_slider_autoplay=t.fill_visibility.bind(t),t.fill_team_slider_adaptive=t.fill_visibility.bind(t),t.fill_team_filter=t.fill_visibility.bind(t),t.fill_team_panel=t.fill_visibility.bind(t),t.fill_team_panel_contacts_visible=t.fill_visibility.bind(t),t.fill_team_panel_social_visible=t.fill_visibility.bind(t),t.fill_team_reveal=t.fill_visibility.bind(t),t.fill_team_body_visible=t.fill_visibility.bind(t),t.fill_team_photo_visible=t.fill_visibility.bind(t),t.fill_team_name_visible=t.fill_visibility.bind(t),t.fill_team_divider_visible=t.fill_visibility.bind(t),t.fill_team_position_visible=t.fill_visibility.bind(t),t.fill_team_short_bio_visible=t.fill_visibility.bind(t),t.fill_team_phone_visible=t.fill_visibility.bind(t),t.fill_team_email_visible=t.fill_visibility.bind(t),t.fill_team_skype_visible=t.fill_visibility.bind(t),t.fill_team_link_visible=t.fill_visibility.bind(t),t.fill_team_location_visible=t.fill_visibility.bind(t),t.fill_team_social_visible=t.fill_visibility.bind(t),t.fill_team_skills_visible=t.fill_visibility.bind(t),t.fill_employer_foto=function(l,e,t){i("#employer-form-foto-remove",ats_panel).show(),""===t&&i("#employer-form-foto-remove",ats_panel).hide();var _=i("<img />").attr("src",t);i(l).find("#employer-form-foto").html("").append(_)},t.fill_employer_panel_text=function(t,_,o){window.employer_panel_text_dfd=i.Deferred(),e.ajax({action:l+"_get_tiny_mce",data:{id:_,content:o},success_handler:function(l){i("."+_,t).html(l),tinyMCE.get(_)&&(tinymce.editors=[]),tinyMCEPreInit.mceInit[_].setup=function(i){i.on("init",function(i){employer_panel_text_dfd.resolve("tinymce init")}),i.on("change",function(l){model.set("custom_fields.panel_text",i.getContent())}),i.on("PostRender")},tinyMCE.init(tinyMCEPreInit.mceInit[_]),quicktags(tinyMCEPreInit.qtInit[_])}})},t.fill_checkbox=function(l,e,t){i(l).find('[name="'+e+'"]').attr("data-checked",t).val(t)},t.fill_team_filter_bold=t.fill_checkbox.bind(t),t.fill_team_name_bold=t.fill_checkbox.bind(t),t.fill_team_position_bold=t.fill_checkbox.bind(t),t.fill_team_short_bio_bold=t.fill_checkbox.bind(t),t.fill_team_contacts_bold=t.fill_checkbox.bind(t),t.fill_team_filter_italic=t.fill_checkbox.bind(t),t.fill_team_name_italic=t.fill_checkbox.bind(t),t.fill_team_position_italic=t.fill_checkbox.bind(t),t.fill_team_short_bio_italic=t.fill_checkbox.bind(t),t.fill_team_contacts_italic=t.fill_checkbox.bind(t),t.fill_select=function(l,e,t){i(l).find('[name="'+e+'"]').val(t),i(l).find('[name="'+e+'"]').dropdown("update")},t.fill_team_layout=t.fill_select.bind(t),t.fill_team_order_by=t.fill_select.bind(t),t.fill_team_hover=t.fill_select.bind(t),t.fill_team_panel_theme=t.fill_select.bind(t),t.fill_team_template=function(l,e,t){var _="",o=window.model.get("layout");i.each(window.templates.get(o),function(i,l){_+='<option value="'+i+'">'+l.label+"</option>"}),i(l).find('[name="'+e+'"]').html("").html(_).val(t),i(l).find('[name="'+e+'"]').dropdown("update")},t.set_employer_photo=function(i,t,_){return e.ajax({action:l+"_get_team_preview_photo",data:{id:i,size:t},success_handler:function(i){var e=""!==i?i:'<img src="'+window[l+"_localize"].default_avatar+'"/>';_(e)}})},t.set_team_employers=function(i,t,_){return e.ajax({action:l+"_get_team_employers_photos",data:{ids:i,size:t},success_handler:function(i){_(i)}})},t.get_templates=function(){return e.ajax({action:l+"_get_templates",success_handler:function(i){window.templates=new Backbone.NestedModel(i)}})},t.init_departments=function(){return e.ajax({action:l+"_get_taxonomy_terms",data:{taxonomy:l+"-employer-taxonomy"},success_handler:function(i){window.ats_employers_taxonomy_terms=i}})},t.get_employer_form=function(i){return e.ajax({action:l+"_get_employer_form",data:{},success_handler:function(l){i(l)}})}};
var AwesomeForm=function(){"use sctrict";var e=new ATS_Ajax,t=jQuery,a=this;a.clear=function(){a.content=t(".a-slide-panel-content",ats_panel);var e=t(a.content).find('input[type!="button"], textarea');t.each(e,function(e,a){t(a).val(""),t(a).html("")}),t("#team-sortable",ats_panel).html(""),t(".alert",ats_panel).html("").attr("class","alert")},a.fill=function(l){var n=t.Deferred(),r=window.model.get("model");if(!t.isEmptyObject(l)){var i=model.get("fill_rules");t.each(l,function(l,n){if("object"!=typeof n||n instanceof Array||"styles"!=l){var o=r+"_"+l;if(-1==t.inArray(l,i))return void t('[name="'+o+'"]',ats_panel).val("").val(n);if(null!==n){var s="fill_"+o;return void e[s](ats_panel,o,n)}}else a.fill(n[model.get("layout")])})}return n.resolve(),n},a.init=function(e){a.clear(),a.fill(e)}};
...
!function(e){"use strict";e(function(){function t(){e('[name="team_template"]',ats_panel).on("change",function(t){var a=model.get("layout"),n=e(this).val();model.set("styles."+a,templates.get(a)[n].styles),model.set("styles."+a+".template",n),preview.destroy(),preview.init()})}function a(){e('[name="team_layout"]',ats_panel).on("change",function(t){model.set("layout",e(this).val()),preview.destroy(),preview.init()})}function n(){window.preview=new AwesomeTeam,preview.init().done(function(){a(),t(),c.init()}),e('[data-action="shortcode-team"]',ats_panel).hide()}function o(){window.preview=new AwesomeTeam,preview.init().done(function(){a(),t()}),c.init(),r()}function i(){preview.destroy(),c.destroy(),e("select",ats_panel).dropdown("destroy")}function d(t){var a=e.Deferred(),n=model.get("employers_ids"),o=e('#teams-list li[team-id="'+model.get("id")+'"] .team-members');return e.each(n,function(e,a){o.append('<li><div class="foto">'+t[e]+"</div>")}),a.resolve(),a}function l(){var t=e.Deferred(),a=model.get("employers_ids"),n=e('#teams-list li[team-id="'+model.get("id")+'"] .team-members');return n.find('li[class!="empty"]').remove(),a.length>0?w.set_team_employers(a,"a-thumbnail",d).then(function(){t.resolve()}):t.resolve(),e('#teams-list li[team-id="'+model.get("id")+'"] span.name').html(model.get("name")),t}function r(){var t=model.get("id");if(0!==t){var a='[a-team-showcase id="'+t+'"]';e('[data-action="shortcode-team"]',ats_panel).find("input").val(a),e('[data-action="shortcode-team"]',ats_panel).show()}}var s="team",c=new AwesomeDrag,m=new AwesomeAjax("ats"),w=new ATS_Ajax,p=new ATS_Animation;e('[data-action="add-team"]').on("click",function(){var e={id:"ats",item_id:"#",parent:"#wpcontent",html:"#team-add-wrap",model_name:s,direction:"right",width:"100%",load_model:w.load_model,callback_open:n,callback_close:i};window.panel=new AwesomePanel(e),panel.init()}),e('[data-action="edit-team"]').on("click",function(){var t=e(this).parents("li[team-id]"),a=parseInt(e(t).attr("team-id")),n={id:"ats",item_id:a,parent:"#wpcontent",html:"#team-edit-wrap",model_name:s,direction:"right",width:"100%",load_model:w.load_model,callback_open:o,callback_close:i};window.panel=new AwesomePanel(n),panel.init()}),e("#team-edit-wrap .save-panel, #team-add-wrap .save-panel").on("click",function(){if(window.model.locked)return!1;var t=e('[data-type="form"]',ats_panel),a=e(t).attr("data-model"),n=t.find(".alert");n.attr("class","alert").hide(),window.model.locked=!0,window.panel.hide_content(),window.panel.animation_start();var o=window.model.clone();o.unset("grid_html"),o.unset("table_html"),o.unset("widget_html"),m.ajax({action:"ats_update_or_new_"+a,data:{data:o.toJSON()},success_handler:function(e){window.model.set("id",e),r(),l().then(function(){window.panel.show_content(),window.panel.animation_end(),window.model.locked=!1})},success_error_handler:function(t){var a="";e.each(t,function(e,t){a+="<p>",a+=t.message,a+="</p>"}),n.addClass("alert-warning").show().html(a),window.panel.show_content(),window.panel.animation_end(),window.model.locked=!1},error_handler:function(e){n.addClass("alert-warning").show().html(e),window.model.locked=!1}})}),e('[data-action="delete-team"]').on("click",function(){var t=e(this).parents("li[team-id]"),a=e(this).find(".a-spinner"),n=e(this).find("svg"),o=parseInt(t.attr("team-id")),i=s;confirm("You really want to delete team?")&&(n.hide(),a.show(),m.delete_model(o,i).then(function(){p.delete_model(t,i)}))}),e('[data-action="shortcode-team"]').on({mouseenter:function(){var t=e(this).find(".a-tooltip-wrapper");setTimeout(function(){t.find("input").select()},300)},mouseleave:function(){e(this).find(".a-tooltip-wrapper")}}),e('[data-action="random-team-style"]').on("click",function(){var t=["base","card_base","card_border","card_divider","card_shadow","card_even_row","name","position","short_bio","contacts","social"];model.random(),e.each(t,function(e,t){var a=t+"_color",n=model.get("layout");_(a,model.get("styles."+n+"."+a))})});var _=function(e,t){("phone_color"==e||"email_color"==e||"skype_color"==e)&&(e="contacts_color"),"object"==typeof window["colorpicker_"+e]&&window["colorpicker_"+e].colorpicker("setValue",t)};e('[data-action="modal"]').lightbox({minWidth:50,minHeight:100}),e('[data-toggle="collapse"]').on("click",function(){var t=e(this).attr("data-target");e(t,ats_panel).toggleClass("in")})})}(jQuery);
!function(e){"use strict";e(function(){function n(n,t){return d.load_model(n,t).then(function(){return d.init_departments().then(function(){var n=e.Deferred(),t=e.Deferred();return window.selectize_instance=e('[name="employer_department"]',ats_panel).selectize({plugins:["restore_on_backspace","remove_button"],delimiter:",",addPrecedence:!1,options:ats_employers_taxonomy_terms||[],items:model.get("department")||[],valueField:"name",labelField:"name",searchField:"name",preload:!0,onInitialize:function(){t.resolve("selectize init")},create:function(e){return{value:e,name:e}},render:{option:function(e,n){return"<div>"+n(e.name)+"</div>"}}}),d.fill_employer_panel_text(ats_panel,"employer_panel_text",model.get("custom_fields.panel_text")),e.when(t,employer_panel_text_dfd).done(function(e,t){n.resolve("both init")}),n})})}function t(){e("#employer-form-foto-remove",ats_panel).hide(),window.preview=new AwesomeEmployer,preview.init()}function a(){"undefined"!=typeof selectize_instance&&"undefined"!=typeof selectize_instance[0]&&"undefined"!=typeof selectize_instance[0].selectize&&selectize_instance[0].selectize.destroy(),"undefined"!=typeof preview&&preview.destroy(),"indefined"!=typeof tinyMCEPreInit&&(tinyMCEPreInit.mceInit={},tinyMCEPreInit.qtInit={}),e("div.employer_panel_text").html("")}function o(n){e('#employers-list li[employer-id="'+model.get("id")+'"] .foto').html(n)}function i(){var n=model.get("id");d.set_employer_photo(n,"a-small",o),e('#employers-list li[employer-id="'+n+'"] span.name').html(model.escape("name")),e('#employers-list li[employer-id="'+n+'"] span.position').html(model.escape("custom_fields.position"))}var l="employer",r=new AwesomeAjax("ats"),d=new ATS_Ajax,p=new ATS_Animation;e('[data-action="add-employer"]').on("click",function(){var e={id:"ats",item_id:"#",parent:"#wpcontent",html:"#employer-add-wrap",model_name:l,direction:"right",width:"67%",load_model:n,callback_open:t,callback_close:a};window.panel=new AwesomePanel(e),panel.init()}),e('[data-action="edit-employer"]').on("click",function(o){var i=parseInt(e(this).attr("employer-id"));if("delete-employer"!==e(o.target).parents("button").attr("class")&&"delete-employer"!==e(o.target).attr("class")){var r={id:"ats",item_id:i,parent:"#wpcontent",html:"#employer-edit-wrap",model_name:l,direction:"right",width:"67%",load_model:n,callback_open:t,callback_close:a};window.panel=new AwesomePanel(r),panel.init()}}),e("#employer-edit-wrap .save-panel, #employer-add-wrap .save-panel").on("click",function(){var n=e('[data-type="form"]',ats_panel),t=e(n).attr("data-model"),a=n.find('[data-type="employer-alert"]');a.attr("class","alert").hide(),window.panel.hide_content(),window.panel.animation_start(),r.ajax({action:"ats_update_or_new_"+t,data:{data:window.model.toJSON()},success_handler:function(e){window.model.set("id",e),i(),window.panel.show_content(),window.panel.animation_end()},success_error_handler:function(n){var t="";e.each(n,function(e,n){t+="<p>",t+=n.message,t+="</p>"}),a.addClass("alert-warning").show().html(t),window.panel.show_content(),window.panel.animation_end()},error_handler:function(){a.addClass("alert-warning").show().html(data),window.panel.show_content(),window.panel.animation_end()}})}),e("button.delete-employer").on("click",function(){var n=e(this).parents("li"),t=parseInt(n.attr("employer-id")),a=l;confirm("You really want to delete employer?")&&r.delete_model(t,a).then(function(){p.delete_model(n,a)})})})}(jQuery);
