<?php
    ...
    $even_css = '#ats-layout-' . $this->data->ID . ' .employers-box li.even_background_color{background-color:' . $styles['card_even_row_color'] . ';}';
    ...
    echo "<ul team-id='" . $this->data->ID . "' style='border-top: 1px solid $border_color;' class='filter-container employers-box'>";
    if (count($this->data->employers) > 0):
        ...
        foreach ($employers as $employer):
            ...
            echo "<li class='$terms filter-item'
                        style='
                        $gaps;
