var ATS=window.ATS||function(t){"use strict";function e(t,e){t=parseInt(t);var i=parseInt(e.count),o=1==e.autoplay?!0:!1,s=parseInt(e.speed),a=1==e.adaptive?!0:!1;jQuery("#ats-layout-"+t+" > .slider-enabled").slick({speed:1e3,draggable:!1,slidesToShow:i,mobileFirst:!0,slidesToScroll:i,autoplay:o,autoplaySpeed:s,adaptiveHeight:a,prevArrow:'<div type="button" title="Previous" class="ats-button slick-prev"><svg viewBox="0 0 26 26"><use xlink:href="#icon-arrow-left"></use></svg></div>',nextArrow:'<div type="button" title="Next" class="ats-button slick-next"><svg viewBox="0 0 26 26"><use xlink:href="#icon-arrow-right"></use></svg></div>',responsive:d(i)})}function i(e){var i=new AwesomeFilter({container:t('[team-id="'+e+'"].filter-container'),controls:t('[team-id="'+e+'"].filter-controls'),item_selector:".isotope-item",control_selector:".ats-button",control_active:"ats-button-active",attribut:"team-id",id:e});i.init()}function o(e){t('[team-id="'+e+'"] [ats-profile]').on("click",function(){var e=t(this).attr("data-profile");window.open(e,"_self")})}function s(e){e=parseInt(e);var i=t("#ats-layout-"+e);i.addClass("ats-animations-enabled"),AwesomeViewport.add({element:i[0],threshold:"30%",enter:function(){t(this).addClass("ats-transition__in")}}),i.find("li").each(function(e,i){var o=t(this),s=a(o.find(".employer_name .team-field-content").text());s&&t(this).data("name",s).find(".photo-container").attr("data-name","Meet &#xa; "+s).parent().append('<span class="ats-img-caption"><strong>Meet</strong><br>'+s+"</span>")})}function a(t){var e,i=t.indexOf(" ");return e=-1===i?t:t.substring(0,i)}function n(e,i){t('[team-id="'+e+'"].employers-box > li').on("click",function(e){if("a"!=e.target.nodeName.toLowerCase()){var o=t(this).parents(".employers-box").attr("team-id"),s=t(this).attr("employer-id"),a=o+"_"+s;if("object"!=typeof window["ats_"+a+"_panel"]&&!window.la_panel_opened){var n=new AwesomePanel({id:"ats_"+a,direction:"left",width:"500px",height:"100%",animation:i,html:"#ats_employer_panel_"+a});n.init()}}})}function l(e){t('[team-id="'+e+'"].employers-box > li').removeClass("even_background_color");var i=t('[team-id="'+e+'"].employers-box > li').not(".la-hidden");t.each(i,function(e,i){(e+1)%2===0&&t(i).addClass("even_background_color")})}function r(e){var i=t("#ats-layout-"+e);t(".employer_skills .team-field-content",i).css("max-width","auto");var o=function(){var e=t("li[employer-id]",i),o=t(".employer_skills:visible",i).outerWidth();o=10*Math.round(o/10),t(".employer_skills .team-field-content",i).css("max-width",o);var s=t("li .star-background:visible > *",i).outerWidth();t(e).each(function(e,i){var a=t(i),n=t(".employer_skills ul li",a);n.each(function(e,i){var n=parseInt(t(i).attr("data-rating"));t(".star-fill",a).css("max-width",o*n/100),t(".star-background > *",a).each(function(e,i){t(i).css("max-height",s)}),t(".star-fill > *",a).each(function(e,i){t(i).css("max-width",s),t(i).css("max-height",s)})})})};o(),t(window).resize(function(){o()})}function c(){}var d=function(t){return[{breakpoint:1200,settings:{slidesToShow:t,slidesToScroll:t}},{breakpoint:1100,settings:{slidesToShow:8>t?t:8,slidesToScroll:t}},{breakpoint:1024,settings:{slidesToShow:6>t?t:6,slidesToScroll:t}},{breakpoint:768,settings:{slidesToShow:5>t?t:5,slidesToScroll:t}},{breakpoint:667,settings:{slidesToShow:4>t?t:4,slidesToScroll:t}},{breakpoint:568,settings:{slidesToShow:3>t?t:3,slidesToScroll:t}},{breakpoint:400,settings:{slidesToShow:2>t?t:2,slidesToScroll:1}},{breakpoint:1,settings:{slidesToShow:1,slidesToScroll:1}}]};return jQuery(document).ready(function(){var e=AwesomeUtil.detect_os();"MacOS"==e&&t("html").addClass("mac");var i={};location.search.substr(1).split("&").forEach(function(t){t.split("=")[0]in i?i[t.split("=")[0]].push(t.split("=")[1]):i[t.split("=")[0]]=[t.split("=")[1]]});var o=i.team_id,s=i.employee_id,a=jQuery("#ats-layout-"+o),n=jQuery('[team-id="'+o+'"].employers-box > li[employer-id="'+s+'"]');a.length>0&&n.length>0&&(t("html, body").animate({scrollTop:a.offset().top},1e3),setTimeout(function(){n.trigger("click")},1e3))}),{enable_slider:e,init_animations:s,init_filter:i,init_panel:n,bind_profiles:o,paint_rows:l,calc_rating_icons_size:r,calc_social_icons_size:c}}(jQuery);
...
var AwesomeFilter=function(t){"use strict";var o=jQuery,i=this;i.options=t,i.bind=function(){o(i.options.control_selector,i.options.controls).on("click",function(){var t=o(this).attr("data-filter");t="*"==t?t:".awesome-filter-"+t,o(".filter-item "+i.options.control_selector,i.options.controls).removeClass(i.options.control_active),o(this).addClass(i.options.control_active),i.filter(t)})},i.filter=function(t){o(".filter-item",i.options.container).addClass("la-hidden"),o(".filter-item"+t,i.options.container).removeClass("la-hidden"),o(".filter-item").trigger("cssClassChanged")},i.init=function(){i.bind()}};
