...
class LA_Team_Builder_App_Plugin {
    ...
    private function define_ajax_hooks(){
        // Employer REST
        $ajax_class = new Ajax();
        $this->loader->add_action( 'wp_ajax_ats_update_or_new_employer', $ajax_class, 'ajax_handle_update_or_new_employer' );
        ...
        $this->loader->add_action( 'wp_ajax_ats_get_team_preview_photo', $ajax_class, 'ajax_handle_get_team_preview_photo' );

        // Get team employers photos
        $this->loader->add_action( 'wp_ajax_ats_get_team_employers_photos', $ajax_class, 'ajax_handle_get_team_employers_photos' );
        ...
        $this->loader->add_action( 'wp_ajax_ats_get_employer_defaults', $ajax_class, 'ajax_handle_get_employer_defaults' );
	...
	private function define_admin_hooks() {
        ...
        // add action links
        $plugin_basename = plugin_basename( plugin_dir_path( realpath( dirname( __FILE__ ) ) ) . self::$plugin['name'] . '.php' );
